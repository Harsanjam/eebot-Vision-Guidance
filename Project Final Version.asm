...
PTH_E_INT       EQU   $75                       ; If SENSOR_LINE < PTH_E_INT robot must shift right
PTH_F_INT       EQU   $A5                       ; If SENSOR_LINE > PTH_F_INT robot must shift left

INC_DIS         EQU   300                       ; INCREMENT distance
FWD_DIS         EQU   850                       ; FORWARD distance
REV_DIS         EQU   1000                      ; REVERSE distance
STR_DIS         EQU   1000                      ; STRAIGHT distance
TRN_DIS         EQU   13600                     ; TURN distance
